...
import image1 from './paul-frank-kl-ngaiskh-ng-enkprasngkh-black-9214-3686094-2.jpg'
import image2 from './RBS34060049.jpg';
import image3 from './07.jpg';
import image4 from './3nknei.jpg';
              ...
              <li className="row" key={index}>
                <div className="col left">
                  ...
                  <div className="detail">
                    <div className="name">
                      <a href="#" className="detailname">{product.name}</a>
                    </div>
    ...
    return (
      <section className="container">
        ...
        <div className="checkout">
          <button className="checkout2" type="button">Check Out</button>
        </div>
      </section>
    );
  }
